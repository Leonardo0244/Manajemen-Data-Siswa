...
if (isset($_POST['submit'])) {
  ...
  if ($query->rowCount() > 0) {
    ...
    $chngpwd1->execute();
    echo "<script>alert('Password kamu berhasil diubah');</script>";
  } else {
    echo "<script>alert('Email atau no Handphone tidak benar');</script>";
  }
}
        ...
        <div class="row flex-grow">
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left p-5">
              ...
              <h6 class="font-weight-light">Masukkan Alamat email dan nomor hp untuk mereset password!</h6>
