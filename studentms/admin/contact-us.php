...
if (strlen($_SESSION['sturecmsaid'] == 0)) {
  ...
  if (isset($_POST['submit'])) {
    ...
    $query->execute();
    echo '<script>alert("Halaman Hubungi Kami Telah Di update")</script>';
  }
?>
  <!DOCTYPE html>
  <html lang="en">
          ...
          <div class="content-wrapper">
            ...
            <div class="row">
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title" style="text-align: center;">Update Hubungi Kami</h4>
                      ...
                      if ($query->rowCount() > 0) {
                        foreach ($results as $row) {               ?>
                          <div class="form-group">
                            <label for="exampleInputName1">Judul Halaman:</label>
                            <input type="text" name="pagetitle" value="<?php echo $row->PageTitle; ?>" class="form-control" required='true'>
                          </div>
                          <div class="form-group">
                            <label for="exampleInputName1">Deskripsi Halaman:</label>
