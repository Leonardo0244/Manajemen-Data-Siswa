        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title">Update Data Siswa</h3>
            ...
            <div class="row">
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title" style="text-align: center;">Update Data Siswa</h4>
                      ...
                      if ($query->rowCount() > 0) {
                        foreach ($results as $row) {               ?>
                          ...
                          <div class="form-group">
                            ...
                            <select name="stuclass" class="form-control" required='true' readonly>
                          ...
                          <div class="form-group">
                            ...
                            <select name="gender" value="" class="form-control" required='true' readonly>
                          ...
                          <div class="form-group">
                            <label for="exampleInputName1">No Telepon 1</label>
                          ...
                          <div class="form-group">
                            <label for="exampleInputName1">No Telepon 2</label>
