...
if (strlen($_SESSION['sturecmsaid'] == 0)) {
  ...
  if (isset($_POST['submit'])) {
    ...
    if ($query->rowCount() > 0) {
      ...
      $chngpwd1->execute(); 
      echo '<script>alert("Password Berhasil Terganti")</script>';
    } else {
      echo '<script>alert("Password SKamu Salah")</script>';
    }
  }
?>
  <!DOCTYPE html>
                  ...
                  <div class="card-body">
                    ...
                    <form class="forms-sample" name="changepassword" method="post" onsubmit="return checkpass();">
                      <div class="form-group">
                        <label for="exampleInputName1">Password Sebelumnya</label>
                      ...
                      <button type="submit" class="btn btn-primary mr-2" name="submit">Ganti</button>
                    </form>
                  </div>
                </div>
              </div>
