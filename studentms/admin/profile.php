...
if (strlen($_SESSION['sturecmsaid'] == 0)) {
  ...
  if (isset($_POST['submit'])) {
    ...
    $query->execute();
    echo '<script>alert("Profilmu Telah Di update")</script>';
          ...
          <div class="content-wrapper">
            ...
            <div class="row">
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title" style="text-align: center;">Profil Admin</h4>
                    <form class="forms-sample" method="post">
                      ...
                      if ($query->rowCount() > 0) {
                        foreach ($results as $row) {               ?>
                          ...
                          <div class="form-group">
                            <label for="exampleInputCity1">Tanggal Registrasi Admin</label>
