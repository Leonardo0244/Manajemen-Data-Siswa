                ...
                <div class="card">
                  <div class="card-body">
                    <div class="d-sm-flex align-items-center mb-4">
                      <h4 class="card-title mb-sm-0">Data Kelas</h4>
                      <a href="#" class="text-dark ml-auto mb-3 mb-sm-0">Lihat Semua Data Kelas</a>
                    </div>
                      ...
                      <table class="table">
                        <thead>
                          <tr>
                            ...
                            <th class="font-weight-bold">Tanggal Di buat</th>
