    ...
    <li class="nav-item">
      ...
      <div class="collapse" id="ui-basic">
        <ul class="nav flex-column sub-menu">
          ...
          <li class="nav-item"> <a class="nav-link" href="manage-class.php">Atur Kelas</a></li>
        </ul>
      </div>
    </li>
    <li class="nav-item">
      ...
      <div class="collapse" id="ui-basic1">
        <ul class="nav flex-column sub-menu">
          ...
          <li class="nav-item"> <a class="nav-link" href="manage-students.php">Atur Data Siswa</a></li>
        </ul>
      </div>
    </li>
    <li class="nav-item">
      ...
      <div class="collapse" id="auth">
        <ul class="nav flex-column sub-menu">
          ...
          <li class="nav-item"> <a class="nav-link" href="manage-notice.php"> Atur Pengumuman </a></li>
        </ul>
      </div>
    </li>
    <li class="nav-item">
      ...
      <div class="collapse" id="auth1">
        <ul class="nav flex-column sub-menu">
          <li class="nav-item"> <a class="nav-link" href="add-public-notice.php"> Tambah Pengumuman Publik </a></li>
          <li class="nav-item"> <a class="nav-link" href="manage-public-notice.php"> Atur Pengumuman Publik </a></li>
        </ul>
      </div>
    <li class="nav-item">
      ...
      <div class="collapse" id="auth2">
        <ul class="nav flex-column sub-menu">
          ...
          <li class="nav-item"> <a class="nav-link" href="contact-us.php"> Hubungi Kami </a></li>
        </ul>
      </div>
    </li>
    <li class="nav-item">
