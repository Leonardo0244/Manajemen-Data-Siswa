...
<html lang="en">
  <head> 
    <title>Halaman Tanggal Laporan</title>
    <!-- plugins:css -->
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> Halaman Laporan </h3>
            ...
            <div class="row">   
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title" style="text-align: center;">Tanggal Laporan</h4>       
                    <form class="forms-sample" method="post" action="between-date-reprtsdetails.php">                    
                     ...
                     <div class="form-group">
                        <label for="exampleInputName1">Sampai Tanggal:</label>
