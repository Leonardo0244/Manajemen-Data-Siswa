...
if (strlen($_SESSION['sturecmsaid'] == 0)) {
  ...
  if (isset($_POST['submit'])) {
    ...
    if ($LastInsertId > 0) {
      echo '<script>alert("Pengumuman Sudah Di Tambahkan.")</script>';
      echo "<script>window.location.href ='add-public-notice.php'</script>";
    } else {
      echo '<script>alert("Sesuatu Salah. Coba Kembali")</script>';
    }
  }
?>
  <!DOCTYPE html>
  ...
  <head>
    <title>Tambah Pengumuman Publik</title>
    <!-- plugins:css -->
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title">Pengumuman Publik </h3>
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
                  <li class="breadcrumb-item active" aria-current="page"> Pengumuman Publik</li>
                </ol>
              </nav>
            </div>
            <div class="row">
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title" style="text-align: center;">Tambah Pengumuman Publik</h4>
