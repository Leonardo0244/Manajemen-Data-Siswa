...
if (strlen($_SESSION['sturecmsaid'] == 0)) {
  ...
  if (isset($_POST['submit'])) {
    ...
    $query->execute();
    echo '<script>alert("Kelas telah di update")</script>';
  }
?>
  <!DOCTYPE html>
  <html lang="en">
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title">Update Data Kelas </h3>
            ...
            <div class="row">
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title" style="text-align: center;">Update Data Kelas</h4>
                    <form class="forms-sample" method="post">
                      ...
                      if ($query->rowCount() > 0) {
                        foreach ($results as $row) {   ?>
                          ...
                          <div class="form-group">
                            <label for="exampleInputEmail3">Pilihan</label>
