                    ...
                    <div class="row report-inner-cards-wrapper">
                      <div class=" col-md -6 col-xl report-inner-card">
                        <div class="inner-card-text">
                          ...
                          ?>
                          <span class="report-title">Jumlah Kelas</span>
                          <h4><?php echo htmlentities($totclass); ?></h4>
                          <a href="manage-class.php"><span class="report-count">Lihat Total</span></a>
                        </div>
                      ...
                      <div class="col-md-6 col-xl report-inner-card">
                        <div class="inner-card-text">
                          ...
                          <a href="manage-students.php"><span class="report-count">Lihat Total</span></a>
                        </div>
                      ...
                      <div class="col-md-6 col-xl report-inner-card">
                        <div class="inner-card-text">
                          ...
                          ?>
                          <span class="report-title">Total Pengumuman Kelas</span>
                          <h4><?php echo htmlentities($totnotice); ?></h4>
                          <a href="manage-notice.php"><span class="report-count">Lihat Total</span></a>
                        </div>
                      ...
                      <div class="col-md-6 col-xl report-inner-card">
                        <div class="inner-card-text">
                          ...
                          ?>
                          <span class="report-title">Total Pengumuman Publik</span>
                          <h4><?php echo htmlentities($totpublicnotice); ?></h4>
                          <a href="manage-public-notice.php"><span class="report-count">Lihat Total</span></a>
                        </div>
