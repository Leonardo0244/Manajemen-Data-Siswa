      ...
      <div class="slider">
        <div class="callbacks_container">
          <ul class="rslides" id="slider">
            <li>
              <h3>Web Data Siswa</h3>
              <p>Murid yang sudah di registrasi bisa login</p>
              <div class="readmore">
                <a href="user/login.php">Login Murid<i class="glyphicon glyphicon-menu-right"> </i></a>
              </div>
            </li>
